...
class _WmsScreenState extends ConsumerState<WmsScreen> with SingleTickerProviderStateMixin {
      ...
      children: [
        Container(
          ...
          child: TabBar(
            ...
            tabs: const [Tab(text: 'INVENTORY'), Tab(text: 'STOCK OPNAME'), Tab(text: 'MUTASI')],
          ),
        ),
        Expanded(child: TabBarView(controller: _tabController, children: const [InventoryTab(), OpnameTab(), MutationTab()])),
      ],
    );
  }
}