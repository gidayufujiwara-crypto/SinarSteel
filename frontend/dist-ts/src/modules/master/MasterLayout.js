...
const MasterLayout = () => {
    ...
    return (_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-text-primary font-orbitron tracking-[2px] uppercase mb-4", children: "Data Master" }), _jsx("div", { className: "flex gap-2 mb-6 border-b border-[rgba(0,245,255,0.15)] pb-2 overflow-x-auto", children: tabs.map((tab) => {
